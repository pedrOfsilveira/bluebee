...
<template>
  <div class="section" id="challenge-section">
    <SectionTitle title="Meus Desafios Ativos" icon="fas fa-rocket" :seeAll="true" to="/challenges" bb/>
    <div class="challenges-container">
      <ChallengeCard v-for="(challenge, index) in limitedChallenges" :key="index" :challenge="challenge" :completed="challenge.completed" />
    </div>
  </div>
</template>
