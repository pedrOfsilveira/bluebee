...
export const useStoreInvestorProfile = defineStore("investorProfile", () => {
  ...
  const questions = ref([
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: "Vejo como oportunidade de compra",
          value: "oportunidade",
          points: 3,
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          label: "Crescer patrimônio com algum risco",
          value: "crescimento",
          points: 2,
        },
        {
          label: "Apostar alto para ganhar muito",
          value: "agressivo",
          points: 3,
        },
      ],
  ...
  const totalScore = computed(() =>
    userPoints.value.reduce((a, b) => a + b, 0),
  );
